...
- Frontend source contracts cover true fullscreen host-modal promotion, the compact single topbar, prompt Expand All / Collapse All, variable-pane thirds/halves with Show More, readable variable cards, dry-run search/content collapse, dual editors, and native variable sidecar geometry.
...
- Distribution bundles are regenerated from the 0.3.0 source and pass `node --check`.
